<?php
/**
 * List Table API: MSSitesListTable class
 *
 * @package WordPress
 ...
 * @see ListTable
 */
class MSSitesListTable extends ListTable
{
    ...
    public function prepare_items()
    {
        ...
        $total_sites = get_sites(array_merge($args, [
            'count' => true,
            'offset' => 0,
            'number' => 0,
        ]));
    ...
    public function column_users($blog)
    {
        ...
        if (!$user_count) {
            $blog_users = get_users(['blog_id' => $blog['blog_id'], 'fields' => 'ID']);
