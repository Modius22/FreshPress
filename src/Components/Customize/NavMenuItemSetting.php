<?php
/**
 * Customize API: NavMenuItemSetting class
 *
 * @package WordPress
 ...
 * @see Setting
 */
class NavMenuItemSetting extends Setting
{
     ...
     *                           entirely. See NavMenuItemSetting::$default for what the value
     *                           should consist of.
     * @return null|void
     */
