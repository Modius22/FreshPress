<?php
/**
 * Upgrade API: PluginUpgrader class
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 4.6.0
...
class PluginUpgrader extends Upgrader
{
     ...
     *
     * Hooked to the {@see 'upgrader_pre_install'} filter by PluginUpgrader::upgrade().
     *
     * @since 2.8.0
     ...
     * PluginUpgrader::upgrade() and PluginUpgrader::bulk_upgrade().
     *
     * @since 2.8.0
     * @access public
     *
