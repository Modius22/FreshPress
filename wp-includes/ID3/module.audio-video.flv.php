                        ...
                        if ($info['flv']['video']['videoCodec'] == GETID3_FLV_VIDEO_H264) {
                            ...
                            switch ($PictureSizeType) {
                                case 0:
                                    ...
                                    $PictureSizeEnc['x'] = getid3_lib::BigEndian2Int(substr($FLVvideoHeader, 4,
                                            2)) >> 7;
                                    $PictureSizeEnc['y'] = getid3_lib::BigEndian2Int(substr($FLVvideoHeader, 5,
                                            2)) >> 7;
                                ...
                                case 1:
                                    $PictureSizeEnc['x'] = getid3_lib::BigEndian2Int(substr($FLVvideoHeader, 4,
                                            3)) >> 7;
                                    $PictureSizeEnc['y'] = getid3_lib::BigEndian2Int(substr($FLVvideoHeader, 6,
                                            3)) >> 7;
...
class AVCSequenceParameterSetReader
{
    ...
    {
        $result = (getid3_lib::BigEndian2Int(substr($this->sps, $this->currentBytes,
