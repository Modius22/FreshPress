...
class getid3_dts extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if (($encoding = array_search($sync, self::$syncwords)) !== false) {
            ...
            return $this->error('Expecting "' . implode('| ', array_map('getid3_lib::PrintHexBytes',
                    self::$syncwords)) . '" at offset ' . $info['avdataoffset'] . ', found "' . getid3_lib::PrintHexBytes($sync) . '"');
        ...
        $info['dts']['dialog_normalization'] = self::dialogNormalization($info['dts']['raw']['dialog_normalization'],
