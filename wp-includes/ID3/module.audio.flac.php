...
class getid3_flac extends getid3_handler
{
    ...
    private function parseSEEKTABLE($BlockData)
    {
        ...
        while ($offset < $BlockLength) {
            ...
            if ($SampleNumberString == $placeholderpattern) {
                ...
                $info['flac']['SEEKTABLE'][$SampleNumber]['offset'] = getid3_lib::BigEndian2Int(substr($BlockData,
                    $offset, 8));
                $offset += 8;
                $info['flac']['SEEKTABLE'][$SampleNumber]['samples'] = getid3_lib::BigEndian2Int(substr($BlockData,
                    $offset, 2));
                $offset += 2;
    ...
    private function parseCUESHEET($BlockData)
    {
        ...
        $offset += 8;
        $info['flac']['CUESHEET']['flags']['is_cd'] = (bool)(getid3_lib::BigEndian2Int(substr($BlockData, $offset,
                1)) & 0x80);
        $offset += 1;
        ...
        for ($track = 0; $track < $info['flac']['CUESHEET']['number_tracks']; $track++) {
            ...
            $info['flac']['CUESHEET']['tracks'][$TrackNumber]['index_points'] = getid3_lib::BigEndian2Int(substr($BlockData,
                $offset, 1));
            $offset += 1;
