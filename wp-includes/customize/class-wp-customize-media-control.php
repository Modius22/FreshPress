    ...
    public function to_json()
    {
        ...
        if (is_object($this->setting)) {
            if ($this->setting->default) {
                ...
                $type = in_array(substr($this->setting->default, -3),
                    array('jpg', 'png', 'gif', 'bmp')) ? 'image' : 'document';
                                                            ...
                                                            <# } else if ( 'video' === data.attachment.type ) { #>
                                                                <div class="wp-media-wrapper wp-video">
                                                                    <video controls="controls"
                                                                           class="wp-video-shortcode" preload="metadata"
                                                                ...
                                                                <# } else { #>
                                                                    <img class="attachment-thumb type-icon icon"
                                                                         ...
                                                                         draggable="false" alt=""/>
                                                                    <p class="attachment-title">{{ data.attachment.title
                                                                        }}</p>
                                                                    <# } #>
                </div>
                <div class="actions">
