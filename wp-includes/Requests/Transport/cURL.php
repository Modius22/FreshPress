...
class Requests_Transport_cURL implements Requests_Transport
{
    ...
    public function request_multiple($requests, $options)
    {
        ...
        foreach ($requests as $id => $request) {
            ...
            $subhandles[$id] = $subrequests[$id]->get_subrequest_handle($request['url'], $request['headers'],
            ...
            foreach ($to_process as $key => $done) {
                ...
                if (CURLE_OK !== $done['result']) {
                    ...
                    $options['hooks']->dispatch('transport.internal.parse_error',
                        array(&$responses[$key], $requests[$key]));
                } else {
                    $responses[$key] = $subrequests[$key]->process_response($subrequests[$key]->response_data,
                        $options);
