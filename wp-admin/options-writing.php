    ...
    <form method="post" action="options.php">
        ...
        if (apply_filters('enable_update_services_configuration', true)) {
            ...
            <?php if (1 == get_option('blog_public')) : ?>
                ...
                <p>
                    <label for="ping_sites"><?php _e('When you publish a new post, WordPress automatically notifies the following site update services. For more about this, see <a href="https://codex.wordpress.org/Update_Services">Update Services</a> on the Codex. Separate multiple service URLs with line breaks.') ?></label>
                </p>
