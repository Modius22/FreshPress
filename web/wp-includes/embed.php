 ...
 * @param WP_HTTP_Response $result Result to send to the client. Usually a Devtronic\FreshPress\Components\Rest\Response.
    ...
    <script type="text/javascript">
        ...
        !function (a, b) {
            ...
            function d() {
                ...
                function g(a) {
                    var c, d, e = a.target, f = e.parentElement.previousElementSibling,
                        g = e.parentElement.nextElementSibling;
                ...
                if (!k) {
                    k = !0;
                    var j, l = b.querySelector(".wp-embed-share-dialog"),
                        m = b.querySelector(".wp-embed-share-dialog-open"),
                        n = b.querySelector(".wp-embed-share-dialog-close"),
                        o = b.querySelectorAll(".wp-embed-share-input"),
                        p = b.querySelectorAll(".wp-embed-share-tab-button button"),
                        q = b.querySelector(".wp-embed-featured-image img");
                    ...
                    }, !1), a.self !== a.top && (c("height", Math.ceil(b.body.getBoundingClientRect().height)), q && q.addEventListener("load", function () {
...
function the_embed_site_title()
{
    $site_title = sprintf(
        ...
        esc_url(home_url()),
        esc_url(get_site_icon_url(32, admin_url('assets/images/w-logo-blue.png'))),
        esc_url(get_site_icon_url(64, admin_url('assets/images/w-logo-blue.png'))),
