...
if (!function_exists('wp_mail')) :
     ...
     */
        ...
        try {
            ...
            do_action('wp_mail_failed', new Error('wp_mail_failed', $e->getMessage(), $mail_error_data));
        ...
        try {
             ...
             * @since 4.4.0
             *
             * @param Error $error A Error object with the phpmailerException message, and an array
...
if (!function_exists('wp_authenticate')) :
     ...
     * @return User|Error User object if the credentials are valid,
     *                          otherwise Error.
     */
    function wp_authenticate($username, $password)
    {
         ...
         * @since 4.5.0 `$username` now accepts an email address.
         *
         * @param null|User|Error $user User if the user is authenticated.
         *                                        Error or null otherwise.
...
if (!function_exists('wp_salt')) :
     ...
     * in the database and in the app/config/parameters.yml file. The secret key in the database
     * is randomly generated and will be appended to the secret keys in app/config/parameters.yml.
     *
     * The secret keys in app/config/parameters.yml should be updated to strong, random keys to maximize
     * security. Below is an example of how the secret key constants are defined.
     * Do not paste this example directly into app/config/parameters.yml. Instead, have a
     * {@link https://api.wordpress.org/secret-key/1.1/salt/ secret key created} just
     * for you.
     *
     * security:
     *     auth_key:         ' Xakm<o xQy rw4EMsLKM-?!T+,PFF})H4lzcW57AF0U@N@< >M%G4Yt>f`z]MON'
     *     secure_auth_key:  'LzJ}op]mr|6+![P}Ak:uNdJCJZd>(Hx.-Mh#Tz)pCIU#uGEnfFz|f ;;eU%/U^O~'
     *     logged_in_key:    '|i|Ux`9<p-h$aFf(qnT:sDO:D1P^wZ$$/Ra@miTJi9G;ddp_<q}6H1)o|a +&JCM'
     *     nonce_key:        '%:R{[P|,s.KuMltH5}cI;/k<Gx~j!f0I)m_sIyu+&NJZ)-iO>z7X>QYR0Z_XnZ@|'
     *     auth_salt:        'eZyT)-Naw]F8CwA*VaW#q*|.)g@o}||wf~@C-YSt}(dh_r6EbI#A,y|nU2{B#JBW'
     *     secure_auth_salt: '!=oLUTXh,QW=H `}`L|9/^4-3 STz},T(w}W<I`.JjPi)<Bmf1v,HpGe}T1:Xt7n'
     *     logged_in_salt:   '+XSqHc;@Q*K_b|Z?NC[3H!!EONbh.n<+=uKR:>*c(u`g~EJBf#8u#R{mUEZrozmm'
     *     nonce_salt:       'h`GXHhD>SLWVfg1(1(N{;.V!MoE(SfbA_ksP@&`+AycHcAV$+?@3q+rxV{%^VyKT'
     *
