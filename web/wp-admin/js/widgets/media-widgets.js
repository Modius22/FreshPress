...
wp.mediaWidgets = ( function( $ ) {
	...
	component.MediaWidgetControl = Backbone.View.extend({
         ...
         * exported from PHP to JS such as is done in Devtronic\FreshPress\Components\Widgets\ImageWidget::enqueue_admin_scripts().
		 *
		 * @type {Object}
		 */
		l10n: {
         ...
         * such as is done in Devtronic\FreshPress\Components\Widgets\ImageWidget::enqueue_admin_scripts(). If not,
         ...
         * such as is done in Devtronic\FreshPress\Components\Widgets\ImageWidget::enqueue_admin_scripts().
		 *
		 * @type {string}
		 */
		mime_type: '',
